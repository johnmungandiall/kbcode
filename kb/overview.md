...
**kbcode** is a terminal-based AI coding agent (v1.11.0) that blends five ideas
...
## Version
- `kbcode/__init__.py:9` — `__version__ = "1.11.0"`; release history in [[changelog]]

last indexed: 2026-07-02 (v1.11.0 release)
